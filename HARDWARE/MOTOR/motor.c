#include "motor.h"
/**************************************************************************/
void MiniBalance_Motor_Init(void)   ///////////////四个IO口分两组控制两个电机的正转反转
{
...
void MiniBalance_PWM_Init(u16 arr,u16 psc)          ///输出两路波形，配合MiniBalance_Motor_Init(void)中的正转反转
{		 		
	 GPIO_InitTypeDef GPIO_InitStructure;
   ...
   //设置该引脚为复用输出功能,输出TIM1 CH1 CH4的PWM脉冲波形
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_8|GPIO_Pin_11|GPIO_Pin_10|GPIO_Pin_9; //TIM_CH1 //TIM_CH4

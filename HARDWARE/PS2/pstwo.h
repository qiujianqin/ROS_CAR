...
#define DO_H PCout(15)=1        //命令位高
#define DO_L PCout(15)=0        //命令位低

#define CS_H PCout(14)=1       //CS拉高
#define CS_L PCout(14)=0       //CS拉低

#define CLK_H PCout(13)=1      //时钟拉高
#define CLK_L PCout(13)=0      //时钟拉低
